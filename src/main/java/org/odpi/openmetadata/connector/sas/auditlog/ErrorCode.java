...
public enum ErrorCode implements ExceptionMessageSet {
    ...
    INVALID_CLASSIFICATION_FOR_ENTITY(400, "OMRS-SAS-CATALOG-REPOSITORY-400-006",
            "SAS Catalog repository is unable to assign a classification of type {0} to an entity of type {1} because the classification type is not valid for this type of entity",
    ...
    INVALID_RELATIONSHIP_ENDS(400, "OMRS-SAS-CATALOG-REPOSITORY-400-047",
    ...
    INVALID_INSTANCE(400, "OMRS-SAS-CATALOG-REPOSITORY-400-061",
    ...
    HOME_REFRESH(400, "OMRS-SAS-CATALOG-REPOSITORY-400-063",
    ...
    REST_CLIENT_FAILURE(500, "OMRS-SAS-CATALOG-REPOSITORY-500-001 ",
            "The SAS Catalog REST API was not successfully initialized to \"{0}\"",
            "The system was unable to login to or access the SAS Catalog environment via REST API.",
            "Check your authorization details are accurate, the SAS Catalog environment started, and is network-accessible."),
    INVALID_SEARCH(500, "OMRS-SAS-CATALOG-REPOSITORY-500-002 ",
            "The SAS Catalog system was unable to process the search \"{0}\"",
            "The system was unable to run the search against SAS Catalog via REST API.",
            "Check the system logs and diagnose or report the problem."),
    REGEX_NOT_IMPLEMENTED(501, "OMRS-SAS-CATALOG-REPOSITORY-501-001 ",
    ...
    NO_HISTORY(501, "OMRS-SAS-CATALOG-REPOSITORY-501-002 ",
    ...
    ENTITY_NOT_KNOWN(404, "OMRS-SAS-CATALOG-REPOSITORY-404-002 ",
    ...
    RELATIONSHIP_NOT_KNOWN(404, "OMRS-SAS-CATALOG-REPOSITORY-404-003 ",
    ...
    /**
     * The constructor for ErrorCode expects to be passed one of the enumeration rows defined in
     * ErrorCode above.   For example:
     *
     *     ErrorCode   errorCode = ErrorCode.NULL_INSTANCE;
     *
     ...
     */
    ErrorCode(int newHTTPErrorCode, String newErrorMessageId, String newErrorMessage, String newSystemAction, String newUserAction) {
